...
| 🆕 PDF upload, via base64 (API key/Entra)                                            | n/a                                    | [responses-pdfupload-base64-aoai-v1.py](responses-pdfupload-base64-aoai-v1.py), [responses-pdfupload-base64-entra-aoai-v1.py](responses-pdfupload-base64-entra-aoai-v1.py)                                                                         |
| 🆕 PDF upload, via file upload (API key/Entra)                                       | n/a                                      | [responses-pdfupload-aoai-v1.py](responses-pdfupload-aoai-v1.py), [responses-pdfupload-aoai-entra-v1.py](responses-pdfupload-aoai-entra-v1.py)                                                                         |
| 🆕 Code Interpreter (API key/Entra)                                       | n/a                                      | [responses-codeinterpreter-aoai-v1.py](responses-codeinterpreter-aoai-v1.py), [responses-codeinterpreter-entra-aoai-v1.py](responses-codeinterpreter-entra-aoai-v1.py)                                                                         |
...
| MCP remote server with Gradio UI                                                            | n/a                                                                                                                                             | [responses-mcp-mslearn-gradio-aoai-v1.py](responses-mcp-mslearn-gradio-aoai-v1.py)                                                                         |
